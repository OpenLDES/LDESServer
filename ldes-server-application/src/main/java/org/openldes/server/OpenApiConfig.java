...
public class OpenApiConfig {
    private static final String ADMIN_PACKAGE = "org.openldes.server.admin.rest";
    private static final String KAFKA_DEBUG_PACKAGE = "org.openldes.server.ingest.kafka";
    @Bean
